...
<head>  
  ...
  <link rel="stylesheet" href="/onlinemusic/s/jPlayer/jplayer.flat.css" type="text/css" />
      ...
      <section class="m-b-lg">
        ...
        <form action="" method="post">
          <div class="form-inline">
            <input type="email" placeholder="邮箱" class="form-control rounded input-lg text-center no-border" required ><button type="button" class="btn btn-warning lt b-white  btn-rounded" style="height:3em">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;发送邮件&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</button>
          </div>
          <br>
          <div class="form-group">
            <input  placeholder="邮箱验证码" class="form-control rounded input-lg text-center no-border" required>
          </div>
          <div class="form-group">
             <input type="password" id="password" placeholder="新密码" class="form-control rounded input-lg text-center no-border" required  pattern="^[a-z]([a-z0-9])*[-_]?([a-z0-9]+)$" title="*密码至少需要8个字符，必须以字母开头，以字母或数字结尾，可以有-和_" >
          </div>
          <div class="form-group">
          ...
          <a href="/onlinemusic/frontdesk/signin.jsp" class="btn btn-lg btn-info btn-block btn-rounded">登录</a>
        </form>
      </section>
    </div>
  </section>
