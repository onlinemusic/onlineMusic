      ...
      <section class="m-b-lg">
        ...
        <form action="" method="post">
          <div class="form-group">
            <input placeholder="用户名" class="form-control rounded input-lg text-center no-border" pattern="^[a-zA-Z0-9]{3,6}$" title="*用户名要求3到6位(字母，数字)" required>
          </div>
          <div class="form-group">
            <input type="email" placeholder="邮箱" class="form-control rounded input-lg text-center no-border" required>
          </div>
          <div class="form-group">
             <input type="password" id="password" placeholder="密码" class="form-control rounded input-lg text-center no-border" required  pattern="^[a-z]([a-z0-9])*[-_]?([a-z0-9]+)$" title="*密码至少需要8个字符，必须以字母开头，以字母或数字结尾，可以有-和_" >
          </div>
          <div class="form-group">
