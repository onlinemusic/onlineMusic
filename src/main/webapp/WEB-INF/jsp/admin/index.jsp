...
<html lang="en">
    ...
    <head>
        ...
        <link href="/resources/assets/css/lib/chartist/chartist.min.css" rel="stylesheet">
        ...
        <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
            <div class="nano">
                <div class="nano-content">
                    <ul>
                        <div class="logo"><a href="index.jsp"><!-- <img src="/resources/assets/images/logo.png" alt="" /> --><span>Online Music</span></a></div>
                        <li class="label">主模块</li>
                        ...
                        <li class="label">音乐管理</li>
                        <li><a  href="<%=basePath%>musicList"><i class="ti-bar-chart-alt"></i>  音乐列表 </a>

                        </li>
                        <li><a href="app-event-calender.html"><i class="ti-calendar"></i> 音乐上传 </a></li>

                        <li class="label">用户管理</li>
                        <li><a class="sidebar-sub-toggle"><i class="ti-layout"></i> <span>用户列表</span></a>

                        </li>



                        <li class="label">评论管理</li>
                        <li><a href="form-basic.html"><i class="ti-view-list-alt"></i> 评论管理 </a></li>
...
<jsp:include page="sidebar.jsp"></jsp:include>
                                                ...
                                                <div class="testimonial-widget-one owl-carousel owl-theme">
                                                    <div class="item">
                                                        <div class="testimonial-content">
                                                            ...
                                                            <img class="testimonial-author-img" src="/resources/assets/images/avatar/1.jpg" alt="" />
                                    ...
                                    <div class="recent-comment m-t-15">
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"><img class="media-object" src="/resources/assets/images/avatar/1.jpg" alt="..."></a>
                                            </div>
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"><img class="media-object" src="/resources/assets/images/avatar/2.jpg" alt="..."></a>
                                            </div>
                                            <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"><img class="media-object" src="/resources/assets/images/avatar/3.jpg" alt="..."></a>
                                            </div>
                                            <div class="media-body">
        ...
        <script src="/resources/assets/js/lib/circle-progress/circle-progress.min.js"></script>
        <script src="/resources/assets/js/lib/circle-progress/circle-progress-init.js"></script>
        <script src="/resources/assets/js/lib/chartist/chartist.min.js"></script>
        <script src="/resources/assets/js/lib/sparklinechart/jquery.sparkline.min.js"></script>
        <script src="/resources/assets/js/lib/sparklinechart/sparkline.init.js"></script>
